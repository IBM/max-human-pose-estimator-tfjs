...
import { cocoParts, cocoPairs, cocoPairsNetwork } from './coco-common.js'
import { guiState } from './control-panel.js'
...
const getUpdatedParams = function () {
  NMSWindowSize = guiState.postProcess.nmsWindowSize
  NMSThreshold = guiState.postProcess.nmsThreshold
  LocalPAFThreshold = guiState.postProcess.localPAFThreshold
  PartScoreThreshold = guiState.postProcess.partScoreThreshold
  PAFCountThreshold = guiState.postProcess.pafCountThreshold
  PartCountThreshold = guiState.postProcess.partCountThreshold
}

export const estimatePoses = function (prediction) {
  getUpdatedParams()
